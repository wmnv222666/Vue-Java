 ...
 * @LastEditTime: 2020-06-11 12:57:13
  ...
  <div class="modal-body no-padding h100">
    <div class="i-box clearfix h100 x-height-table">
      ...
      <vxe-table ref="sTable" :data="list" height="auto" stripe show-overflow resizable>
        ...
        <vxe-table-column min-width="160" field="poCode" :title="$t('DNumber')"></vxe-table-column>
...
export default {
  ...
  methods: {
    ...
    async getData () {
      ...
      var [err, res] = await this.$to(API.AGetListInComing(sendData)); if (err) { return false }
      var data = res.data
