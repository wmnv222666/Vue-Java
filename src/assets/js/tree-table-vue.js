(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory(require('vue')) } else if (typeof define === 'function' && define.amd) { define('tree-table-vue', ['vue'], factory) } else if (typeof exports === 'object') { exports['tree-table-vue'] = factory(require('vue')) } else { root['tree-table-vue'] = factory(root['Vue']) }
                ...
                'tr',
                {
                  ...
                  on: {
                    ...
                    'dblclick': function dblclick ($event) {
                      return _this2.handleEvent($event, 'row', { row: row, rowIndex: rowIndex }, { clickRow: false })
                    },
